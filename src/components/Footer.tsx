    ...
    <footer className={styles.footer}>
      <div className={styles.inner}>
        ...
        <nav className={styles.center} aria-label="Footer navigation">
          <span className={styles.stat}>47 regions</span>
          <span className={styles.dot}>·</span>
          <span className={styles.stat}>92 appellations</span>
          <span className={styles.dot}>·</span>
          <span className={styles.stat}>20 countries</span>
          <span className={styles.dot}>·</span>
          <Link className={styles.legalLink} href="/privacy">Privacy</Link>
          <span className={styles.dot}>·</span>
          <Link className={styles.legalLink} href="/terms">Terms</Link>
          <span className={styles.dot}>·</span>
